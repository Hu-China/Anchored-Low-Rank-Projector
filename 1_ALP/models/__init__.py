from .lowrank_skip import low_rank_skip
from .LoRADIPNet import LoRASkipNet
...
def get_net(input_depth, NET_TYPE, pad, upsample_mode, n_channels=3, act_fun='LeakyReLU', skip_n33d=128, skip_n33u=128,
    ...
    if NET_TYPE == 'low_rank_skip':
        net = low_rank_skip(input_depth, n_channels,
    ...
    elif NET_TYPE == 'LoRA_Skip':
        net = LoRASkipNet(input_depth, n_channels, lora_rank=8,
                            num_channels_down=[skip_n33d] * num_scales if isinstance(skip_n33d, int) else skip_n33d,
                            num_channels_up=[skip_n33u] * num_scales if isinstance(skip_n33u, int) else skip_n33u,
                            num_channels_skip=[skip_n11] * num_scales if isinstance(skip_n11, int) else skip_n11,
